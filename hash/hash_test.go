...
func TestHash_512FirstExample_ok(t *testing.T) {
	message := []byte{
...
func TestHash_256FirstExample_ok(t *testing.T) {
	message := []byte{
		0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39,
		0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39,
		0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39,
...
func TestHash_512SecondExample_ok(t *testing.T) {
	message := []byte{
...
func TestHash_256SecondExample_ok(t *testing.T) {
	message := []byte{
		0xd1, 0xe5, 0x20, 0xe2, 0xe5, 0xf2, 0xf0, 0xe8,
		0x2c, 0x20, 0xd1, 0xf2, 0xf0, 0xe8, 0xe1, 0xee,
		0xe6, 0xe8, 0x20, 0xe2, 0xed, 0xf3, 0xf6, 0xe8,
